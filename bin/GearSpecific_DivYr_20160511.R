...
############################################################################################
####  OBJECTIVE 1: Calc maps of richness for specific gears
loc=("C:/Users/Jenny/Dropbox/1PhD/R.projects/Ch4/GearDiv/data/Ch4_specificGearbyYear")
setwd(loc)
...
# all values >= 0 (no fishing) become 0, all values >=1 = 1 (gear X used in that location)
m <- c(0, 0, 0,  1, 500, 1)
...
###########################
# Task 2.2 calc richness for specific gears
...
writeRaster(r.60,"GearSpecific_DivYr_1960.tif", datatype="FLT4S",format="GTiff", overwrite=TRUE)
writeRaster(r.70,"GearSpecific_DivYr_1970.tif", datatype="FLT4S",format="GTiff", overwrite=TRUE)
writeRaster(r.80,"GearSpecific_DivYr_1980.tif", datatype="FLT4S",format="GTiff", overwrite=TRUE)
writeRaster(r.90,"GearSpecific_DivYr_1990.tif", datatype="FLT4S",format="GTiff", overwrite=TRUE)
writeRaster(r.00,"GearSpecific_DivYr_2000.tif", datatype="FLT4S",format="GTiff", overwrite=TRUE)
writeRaster(r.10,"GearSpecific_DivYr_2010.tif", datatype="FLT4S",format="GTiff", overwrite=TRUE)
